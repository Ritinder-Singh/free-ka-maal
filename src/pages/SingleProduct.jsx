...
const SingleProduct = () => {
  ...
  Moengage.track_event("Product Viewed", {
    "id": productData?.id + size, // string value
    "title": productData?.name, // numeric value
    "price": productData?.price?.current?.value, // numeric value
    "brand": productData?.brandName, // datetime value. Example value represents 31 January, 2017.
  });
  ...
  const addToWishlistHandler = async (product) => {
    Moengage.track_event("Product Added to Wishlist", {
      "id": productData?.id + size, // string value
      "title": productData?.name, // numeric value
      "price": productData?.price?.current?.value, // numeric value
      "brand": productData?.brandName, // datetime value. Example value represents 31 January, 2017.
  ...
  const removeFromWishlistHandler = async (product) => {
    Moengage.track_event("Product removed to Wishlist", {
      "id": productData?.id + size, // string value
      "title": productData?.name, // numeric value
      "price": productData?.price?.current?.value, // numeric value
      "brand": productData?.brandName, // datetime value. Example value represents 31 January, 2017.
