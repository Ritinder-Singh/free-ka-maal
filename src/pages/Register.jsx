...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    Moengage.add_unique_user_id(email); // UNIQUE_ID is used to uniquely identify a user.
    Moengage.add_first_name(name);
    Moengage.add_last_name(lastname);
    Moengage.add_email(email);
    Moengage.add_mobile(phone);
    //Moengage.add_user_name(); // Full name for user
    //Moengage.add_gender("M");
    //Moengage.add_birthday(new Date(1980, 2, 31));
    Moengage.track_event("Registration Complete");
